After creating this issue, comment **`@cursoragent spec`** to start the spec agent.
If it asks questions, reply then comment **`@cursoragent continue spec`**.

See [workflow/cursor-workflow/WORKFLOW.md](https://github.com/BlackLodgeLabs/cuebox/blob/main/workflow/cursor-workflow/WORKFLOW.md).
...
**Library results:** Unchanged from #136 — View; Mark watched (`active`); Complete review (`pending_watch_review`); View only (`watched`).
