...
| `jq --argjson` ARG_MAX in `fetch-agents-list` breaks recovery + babysit spawn; recovery `\|\| true` hides it | [#115](https://github.com/BlackLodgeLabs/cuebox/issues/115) | Rewrite fetch to pipe JSON via file/stdin; remove PR-filter `or (. == .)`; notify-stalled on fetch hard-fail — [#117](https://github.com/BlackLodgeLabs/cuebox/issues/117), [#118](https://github.com/BlackLodgeLabs/cuebox/issues/118) |
| Rapid follow-up push after `*-ready` orphans stage-transition handoff | [#115](https://github.com/BlackLodgeLabs/cuebox/issues/115) | Demo skill single-push `demo-ready` (mirror create-pr amend-in-place); recovery must spawn or notify stalled — [#119](https://github.com/BlackLodgeLabs/cuebox/issues/119), [#118](https://github.com/BlackLodgeLabs/cuebox/issues/118) |
