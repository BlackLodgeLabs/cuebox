...
| [#79](https://github.com/BlackLodgeLabs/cuebox/issues/79) | [#82](https://github.com/BlackLodgeLabs/cuebox/pull/82) | 2026-07-07 | BEFORE_SHA recovery unblocked execute; four concurrent handoffs raced babysit spawn before state recorded — see HANDOFF-HARDENING-NOTES | [WORKFLOW-REVIEW.md](https://github.com/BlackLodgeLabs/cuebox/blob/a1fb56f287241f18134edecfefacf17afbecc4f7/workflow/issues/issue-79/WORKFLOW-REVIEW.md) |
...
| Shallow checkout misses `BEFORE_SHA` on multi-commit pushes | [#79](https://github.com/BlackLodgeLabs/cuebox/issues/79) | `cursor-workflow-ensure-before-sha.sh` + recovery on branch ([#82](https://github.com/BlackLodgeLabs/cuebox/pull/82)); increase `fetch-depth` proposed |
