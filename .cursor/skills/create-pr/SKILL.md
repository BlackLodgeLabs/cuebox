...
| Scenario Results | Embed demo screenshots/recordings from `demo/` using relative paths (e.g. `![scenario 1](demo/scenario-1.png)`); copy pass/fail table from `demo-notes.md` |
...
- UI changes must include embedded demo images in Scenario Results
